...
namespace Lesson10
{
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            Console.WriteLine("Make your choice based on task: ");
            ...
            if (task == 1)
            {
                ...
                var result1 = debtors.Where(d => d.Email.ToLower().EndsWith("@rhyta.com") || d.Email.ToLower().EndsWith("@dayrep.com"));
                Console.WriteLine("Debtors with email domains ending with rhyta.com or dayrep.com:");
            ...
            else if (task == 2)
            {
                ...
                var result2 = debtors.Where(d => (DateTime.Now.Year - d.BirthDay.Year) >= 26 && (DateTime.Now.Year - d.BirthDay.Year) <= 36);
                Console.WriteLine("Debtors whose age is between 26 and 36:");
            ...
            else if (task == 3)
            {
                ...
                Console.WriteLine("Debtors whose debt is less than 5000:");
            ...
            else if (task == 4)
            {
                ...
                Console.WriteLine("Debtors with more than 18 symbols in full name and at least 2 '7's in phone number:");
            ...
            else if (task == 5)
            {
                ...
                Console.WriteLine("Debtors who were born in Winter season:");
            ...
            else if (task == 6)
            {
                ...
                var result6 = debtors.OrderBy(d => d.FullName.Split(' ').Last()).ThenByDescending(d => d.Debt);
                Console.WriteLine("Debtors sorted by surnames then decreasing debts:");
            ...
            else if (task == 7)
            {
                ...
                var result7 = debtors.Where(d => !d.Phone.Contains('8')).Select(d => new { Surname = d.FullName.Split(' ').Last(), Age = DateTime.Now.Year - d.BirthDay.Year, TotalDebt = d.Debt });
                Console.WriteLine("Surnames, ages, and total debts of debtors with no '8' in phone numbers:");
                foreach (var item in result7)
                {
                    Console.WriteLine($"Surname: {item.Surname}, Age: {item.Age}, Total Debt: {item.TotalDebt}");
                }
                Console.WriteLine();
            }
            ...
            else if (task == 8)
            {
                ...
                var result8 = debtors.Where(d => d.FullName.Distinct().Count(c => d.FullName.Count(x => x == c) >= 3) > 0)
                                     .OrderBy(d => d.FullName);
                Console.WriteLine("Debtors with at least 3 same letters in their name and surname, sorted alphabetically:");
            ...
            else if (task == 9)
            {
                ...
                var mostCommonYear = debtors.GroupBy(d => d.BirthDay.Year)
                                            ...
                                            .Select(g => g.Key)
                                            .FirstOrDefault();
                Console.WriteLine($"Year with the most debtors born: {mostCommonYear}");
                Console.WriteLine();
            ...
            else if (task == 10)
            {
                ...
                var topDebtors = debtors.OrderByDescending(d => d.Debt).Take(5);
                Console.WriteLine("Top 5 debtors according to their debts:");
            ...
            else if (task == 11)
            {
                ...
                var totalDebts = debtors.Sum(d => d.Debt);
                Console.WriteLine($"Sum of all debts: {totalDebts}");
                Console.WriteLine();
            }
            ...
            else if (task == 12)
            {
                ...
                var ww2Debtors = debtors.Where(d => d.BirthDay.Year <= 1945);
                Console.WriteLine("Debtors who saw World War 2 (based on their birth date):");
                foreach (var debtor in ww2Debtors)
                {
                    Console.WriteLine(debtor);
                }
                Console.WriteLine();
            ...
            else if (task == 13)
            {
                ...
                var result13 = debtors.Where(d => d.Phone.Distinct().Count() == d.Phone.Length)
                                      .Select(d => new { FullName = d.FullName, Debt = d.Debt });
                Console.WriteLine("Debtors' full names and debts whose phone numbers have no same numbers:");
                foreach (var item in result13)
                {
                    Console.WriteLine($"Full Name: {item.FullName}, Debt: {item.Debt}");
                }
                Console.WriteLine();
            }
            ...
            else if (task == 14)
            {
                ...
                var debtFreeByBirthday = debtors.Where(d => d.BirthDay.AddYears(DateTime.Now.Year - d.BirthDay.Year).AddMonths(d.Debt / 500) <= DateTime.Now);
                Console.WriteLine("Names of debtors who can finish their debts till their birthday by paying 500 per month:");
                foreach (var debtor in debtFreeByBirthday)
                {
            ...
            else if (task == 15)
            {
                ...
                var result15 = debtors.Where(d => d.FullName.Replace(" ", "").ToLower().Intersect("smile").Count() == 5);
                Console.WriteLine("Debtors' full names where we can make a word 'smile' from their full name:");
            ...
            else { Console.WriteLine("There is no task like your choice..."); }
